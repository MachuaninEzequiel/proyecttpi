      ...
      <tbody>
        {ventas.map((user) => (
          <tr>
            ...
            <td></td>
            <th scope="row">{user.fechaventa}</th>
            <td></td>
            <td className="centrado">{user.nombre}</td>
            <td></td>
            <td className="centrado">{user.articulo}</td>
            <td></td>
            <td className="centrado">{user.cantidad}</td>
            <td></td>
            <td className="centrado">{user.total}</td>
            <td></td>
